...
// import { ObservableQueryPools } from '../cosmos/query/pools';
...
export class PoolIntermediatePriceStore extends CoinGeckoPriceStore {
	...
	constructor(
		protected readonly umeeChainId: string,
	...
	getPrice(coinId: string, vsCurrency: string): number | undefined {
	  ...
	  //   const umeeChainInfo = this.chainGetter.getChain(this.umeeChainId);
	  ...
	  //   if (
	  //     !umeeChainInfo.currencies.find(cur => cur.coinMinimalDenom === route.spotPriceSourceDenom) ||
	  // 		!umeeChainInfo.currencies.find(cur => cur.coinMinimalDenom === route.spotPriceDestDenom)
	  //   ) {
	  //     return;
	  //   }
