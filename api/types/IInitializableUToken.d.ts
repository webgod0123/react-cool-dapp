...
interface IInitializableUTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IInitializableUToken extends Contract {
  ...
  interface: IInitializableUTokenInterface;
