...
interface DelegationAwareUTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class DelegationAwareUToken extends Contract {
  ...
  interface: DelegationAwareUTokenInterface;
