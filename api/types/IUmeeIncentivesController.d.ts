...
interface IUmeeIncentivesControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class IUmeeIncentivesController extends Contract {
  ...
  interface: IUmeeIncentivesControllerInterface;
