...
interface UTokensAndRatesHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class UTokensAndRatesHelper extends Contract {
  ...
  interface: UTokensAndRatesHelperInterface;
  ...
  filters: {
    ...
    deployedContracts(uToken: null, strategy: null): EventFilter;
  };
